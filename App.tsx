...
const App: React.FC = () => {
  ...
  const shareToWhatsApp = () => {
    const message = encodeURIComponent("Olá! Acabei de criar minhas fotos Polaroid personalizadas na Anix Copiadora! 📸✨");
      ...
      <header className="no-print mb-12 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 p-6 bg-white rounded-3xl shadow-sm border border-stone-200">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#25D366] hover:bg-[#128C7E] text-white px-8 py-3 rounded-xl font-bold transition-all shadow-lg active:scale-95"
          >
